...
public class MusicGenre__1 {
     ...
     */
    public MusicGenre__1(Integer musicGenreId, Integer musicGenreParentId, String musicGenreName, String musicGenreNameExtended, String musicGenreVanity) {
        super();
